...
Automated analysis of nuclear emulsion exposed to 124Xe+54 ions at about 300 MeV per nucleon at the JINR Nuclotron. Three stacks exposed transversely to the beam, Bragg peak identification, particle classification via Gaussian Mixture Model, and beam profile analysis.
...
│   ├── SRIM/                  # SRIM-2013 simulation files
│   └── analysis/              # Python scripts, ROOT macros, LaTeX report
