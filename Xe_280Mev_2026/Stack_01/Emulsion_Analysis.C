// ================================================
// ImageJ Macro - Emulsion Grain Analysis (Optimized)
// Goal: Beam Profile + Bragg Peak + Particle Classification
// ================================================
...
// Header for summaries (reduced & relevant)
...
for (i = 0; i < list.length; i++) {
    ...
    if ((indexOf(file, "Plate") == 0 || startsWith(file, "1_Plate") || startsWith(file, "2_Plate") || 
         startsWith(file, "3_Plate") || startsWith(file, "4_Plate") || startsWith(file, "5_Plate") ||
         startsWith(file, "6_Plate") || startsWith(file, "7_Plate") || startsWith(file, "8_Plate")) &&
        ...
        if (nResults > 0) {
            ...
            // Save individual and combined summary
        ...
        close(imageTitle);   // Close image
        if (isOpen("Results")) close("Results");
    }
}

print("\n=== PROCESSING COMPLETE ===");
print("Processed " + count + " plates");
