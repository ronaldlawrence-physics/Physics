...
\begin{titlepage}
\begin{center}
\includegraphics[width=4cm]{jinr_logo.png}\\[1cm]
\makeatletter
...
and deuterons at energies up to 4.5\,GeV/nucleon for extracted beams
...
\begin{enumerate}
  ...
  \item \textbf{Superconducting Booster Synchrotron}: Accumulates and
        accelerates ions to 600\,MeV/nucleon before transfer to the
        Nuclotron.
...
\begin{itemize}
  \item \textbf{Radiation hardness of electronics:} Heavy-ion beams at
        ...
        space radiation environment. The xenon beam used here provides
        a well-characterised source of high-LET radiation.
...
%===================================================================
\section{Nuclear emulsion in brief}
\label{sec:emulsion}
%===================================================================

Nuclear emulsion is a particle detector consisting of a photographic
...
the BECQUEREL project at LHEP JINR~\cite{becquerel, zarubin2016}.
...
%===================================================================
\section{SRIM model and runs in our stack}
\label{sec:srim}
%===================================================================

The stopping of \textsuperscript{124}Xe ions in the emulsion--glass
stack was simulated using the SRIM-2013 code~\cite{srim2008}. The
simulation file is located in the \texttt{SRIM/} directory.
...
The full simulation included 8 plate periods (total thickness
16.4\,mm), matching the Stack\,01 configuration.

\begin{table}[H]
\centering
\caption{SRIM target configuration.}
...
\begin{itemize}
  \item \textbf{Ion:} Xe (Z=54, mass 131.904\,amu)
  \item \textbf{Energy:} 280\,MeV (total kinetic energy,
        corresponding to approximately 2.1\,MeV/nucleon)
  \item \textbf{Angle:} 0$^\circ$ (normal incidence)
  \item \textbf{Number of ions:} 4114 (Monte Carlo)
\end{itemize}

\subsection{Range results}

\noindent\textbf{Note:} The SRIM simulation was performed at
280\,MeV total kinetic energy ($\sim$2.1\,MeV/nucleon), which is
substantially lower than the experimental beam energy of
280\,MeV/nucleon. The results below therefore do \emph{not} represent
the experimental range and are presented only to document the
simulation setup and methodology.

The SRIM simulation computed the final positions of all 4114 ions
(Table~\ref{tab:srim_results}). The mean projected range in the
emulsion was:

\[
\langle R \rangle = 1.64 \times 10^5\;\text{\AA}
= 16.4\;\si{\micro\meter}.
\]

All simulated ions stopped within the first emulsion layer (60
\si{\micro\meter}) at a mean depth of 16.4\,\si{\micro\meter}. No ions
penetrated through the first plate. The lateral straggling was
approximately 20--40\,\si{\micro\meter} (FWHM).

\begin{table}[H]
\centering
\caption{SRIM range results for Xe at 280\,MeV total energy.}
\label{tab:srim_results}
\begin{tabular}{lc}
\toprule
Quantity & Value \\
\midrule
Ion & Xe (Z=54, mass 131.904\,amu) \\
Energy (total) & 280\,MeV \\
Energy (per nucleon) & $\sim$2.1\,MeV/nucleon \\
Number of ions simulated & 4114 \\
Mean projected range & 16.4\,\si{\micro\meter} \\
Stopping layer & Layer 1 (emulsion) \\
Ions transmitted & 0 \\
\bottomrule
\end{tabular}
\end{table}
...
\vspace{1em}
\noindent
\textbf{Note:} The SRIM simulation was performed at 280\,MeV total
energy ($\sim$2.1\,MeV/nucleon), which is substantially lower than the
experimental beam energy of $\sim$280\,MeV/nucleon
($\sim$37\,GeV total). At the experimental energy, the SRIM-predicted
range would be on the order of 10--12\,mm, consistent with the
experimentally observed Bragg peak position (see Sec.~\ref{sec:results}).
The simulation in the \texttt{SRIM/} folder therefore models a
low-energy stopping configuration within a single emulsion layer,
rather than the full-energy beam penetration through the entire stack.
...
\begin{description}
  \item[Set Scale:] Calibration of pixel-to-micrometre conversion.
        For Stack\,01, 1.717\,px/\si{\micro\meter} was used (determined from
...
\begin{subfigure}{0.48\textwidth}
  \includegraphics[width=\textwidth]{../4x.jpg}
...
\hfill
\begin{subfigure}{0.48\textwidth}
  \includegraphics[width=\textwidth]{../20x.jpg}
...
\begin{subfigure}{0.48\textwidth}
  \includegraphics[width=\textwidth]{../40x.jpg}
...
\begin{enumerate}
  \item \textbf{Bragg peak position.} The primary Xe beam stops between
        ...
        and~03, consistent with SRIM predictions. Stack~01 shows a
...
Dr.\ A.\ A.\ Zaitsev, and Dr.\ M.\ Natarajan for their supervision,
